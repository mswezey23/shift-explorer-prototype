...
const NetworkMap = function () {
  this.markers = {};
  this.options = {
    center: leaflet.latLng(40, 0), zoom: 1, minZoom: 1, maxZoom: 10,
  };
  ...
  const validLocation = (location) => location && typeof location.latitude === 'number' && typeof location.longitude === 'number';
