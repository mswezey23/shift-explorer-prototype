  ...
  this.getStatistics = function (e, error, success) {
    ...
    (err, results) => {
      ...
      let statistics = {
        ...
        btcVolume: _.reduce(results[0], (memo, t) => (memo + parseFloat(t.btcVolume)), 0.0).toFixed(8),
        shiftVolume: _.reduce(results[0], (memo, t) => (memo + parseFloat(t.shiftVolume)), 0.0).toFixed(8),
        numTrades: _.reduce(results[0], (memo, t) => (memo + parseInt(t.numTrades, 10)), 0),
      };
