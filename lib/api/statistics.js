...
module.exports = function (app) {
  ...
  function Blocks() {
    ...
    this.url = (offset, limit) => setOffsetAndLimit('/api/blocks?&orderBy=height:desc', offset, limit);
  ...
  function Peers(locator) {
    ...
    this.url = (offset, limit) => setOffsetAndLimit('/api/peers?orderBy=ip:asc', offset, limit);

    const osBrands = {
      unknown: 0, darwin: 1, linux: 2, freebsd: 3,
    };
